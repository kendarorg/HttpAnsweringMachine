...
copy %ROOT_DIR%\ham\app\target\app-%HAM_VERSION%.jar %HAM_RELEASE_TARGET%\ham\  1>NUL
copy %ROOT_DIR%\ham\simpledns\target\simpledns-%HAM_VERSION%.jar %HAM_RELEASE_TARGET%\simpledns\  1>NUL
copy %ROOT_DIR%\ham\libs\*.jar %HAM_RELEASE_TARGET%\ham\libs\ 1>NUL
copy %ROOT_DIR%\ham\external\*.* %HAM_RELEASE_TARGET%\ham\external\  1>NUL
copy %ROOT_DIR%\ham\external.json %HAM_RELEASE_TARGET%\ham\ 1>NUL

REM Prepare the run commands
copy %SCRIPT_DIR%\templates\releasebuild\ham\*.sh %HAM_RELEASE_TARGET%\ham\  1>NUL
copy %SCRIPT_DIR%\templates\releasebuild\simpledns\*.sh %HAM_RELEASE_TARGET%\simpledns\  1>NUL
copy %SCRIPT_DIR%\templates\releasebuild\ham\*.bat %HAM_RELEASE_TARGET%\ham\  1>NUL
copy %SCRIPT_DIR%\templates\releasebuild\simpledns\*.bat %HAM_RELEASE_TARGET%\simpledns\  1>NUL
