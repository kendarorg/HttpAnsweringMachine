...
set HAM_JAR=janus-driver-1.1.3.jar
...
start java -cp "be-4.1.3-SNAPSHOT.jar;janus-driver-1.1.3.jar" org.springframework.boot.loader.JarLauncher --spring.config.location=file:///%cd%\bedbham.application.properties
