...
IF "%RUN_INLINE%"=="" (
    ...
    start /b java  -cp "be-%HAM_VERSION%.jar;janus-driver-%JANUS_DRIVER_VERSION%.jar" org.springframework.boot.loader.JarLauncher --spring.config.location=file:///%cd%\bedb.application.properties
)
cd %START_LOCATION%
