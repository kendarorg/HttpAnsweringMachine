...
rm tmp_txt || true
java -cp "be-4.1.4.jar;../janus-driver-1.1.5.jar" org.springframework.boot.loader.JarLauncher --spring.config.location=file://$(pwd)/bedbham.application.properties &
cd $START_LOCATION
