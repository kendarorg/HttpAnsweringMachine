...
set /p JAR_NAME=<.temp.txt
start java -cp "be-4.1.0.jar;../janus-driver-1.0.11-SNAPSHOT.jar" org.springframework.boot.loader.JarLauncher --spring.config.location=file:///%cd%\bedbham.application.properties
