...
start java -cp "be-4.1.3-SNAPSHOT.jar;janus-driver-1.1.5.jar" org.springframework.boot.loader.JarLauncher --spring.config.location=file:///%cd%\bedbhamnogen.application.properties
