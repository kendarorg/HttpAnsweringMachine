  ...
  data:function (){
    return {
      ...
      columns: [
        ...
        {id: "type", template: "string",label:"Type",sortable:true},
        ...
        {id: "requestHost", template: "string",label:"Host",sortable:true},
        {id: "requestPath", template: "string",label:"Path",sortable:true},
        {id: "queryCalc", template: "string",label:"Query",sortable:true},
