...
public class ContentDisposition {
    ...
    private ContentDisposition(@Nullable String type, @Nullable String name, @Nullable String filename,
                               @Nullable String charset, @Nullable Long size, @Nullable String creationDate,
                               @Nullable String modificationDate, @Nullable String readDate) {
    ...
    public static ContentDisposition parse(String contentDisposition) {
        ...
        return new ContentDisposition(type, name, filename, charsetString, size, creationDate, modificationDate, readDate);
    }
