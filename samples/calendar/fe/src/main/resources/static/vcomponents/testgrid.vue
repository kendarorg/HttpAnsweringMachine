<template>
  <div>
      ...
      <span slot="body">
        <table>
          ...
          <tr v-for="(key,index) in columns">
            <td style="color:black;">{{ loadLabel(key) }}</td>
    ...
    <div v-if="pageSize!=null">
      <br>
      <button id="grid-gostart" v-bind:disabled="index<=0" class="bi bi bi-skip-backward icon-black" @click="goStart"
              title="Start"></button>
      <button id="grid-goprev" v-bind:disabled="index<=0" class="bi bi-skip-start icon-black" @click="goPrev"
              title="Prev"></button>
      <button id="grid-gonext" v-bind:disabled="!canGoNext()" class="bi bi-skip-end icon-black" @click="goNext"
              title="Next"></button>
      <button id="grid-goend" v-bind:disabled="!canGoNext()" class="bi bi-skip-forward icon-black" @click="goEnd"
              title="End"></button>
      <!--&nbsp;&nbsp;
    ...
    <div>
      ...
      <button id="grid-visibility" class="bi bi-eyeglasses icon-black" @click="showVisibility()"
    ...
    <table class="rounded-top">
      ...
      <tr style="color:black;" v-for="(entry,index) in filteredData" @click="onClicked(entry,index)">
