...
if [ "$rundocker" == "n" ]; then
	...
	java -jar "$mypath"samples/calendar/gateway/target/gateway-3.0.8-SNAPSHOT.jar &
	...
	java -jar "$mypath"samples/calendar/be/target/be-3.0.8-SNAPSHOT.jar &
	...
	java -jar "$mypath"samples/calendar/fe/target/fe-3.0.8-SNAPSHOT.jar &
